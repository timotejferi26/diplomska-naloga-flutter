...
import 'package:diplomska_naloga/libraries/riverpod/default/notifiers/user_notifier.dart';
...
class GetXStateAdapter extends UserStateAdapter {
  ...
  @override
  List<User> get users => List<User>.of(_controller.users);
...
class WatchItStateAdapter extends UserStateAdapter {
  ...
  Future<void> initialize() async {
    ...
    await _waitForListenable(_viewModel, () => !_viewModel.isLoading);
    expect(_viewModel.error, isNull);
  }

  @override
  List<User> get users => List<User>.of(_viewModel.users);
