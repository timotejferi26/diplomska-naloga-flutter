...
//
// Consumer at page level watches the full notifier for loading/error state.
// Each card uses context.select() to watch only its own user slice.
...
import 'package:diplomska_naloga/libraries/provider/default/widgets/provider_user_card.dart';
